                ...
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <nav class="medicare-nav d-none d-md-flex">
                            <a href="index.jsp" class="nav-link ${param.activePage == 'home' ? 'active' : ''}">Home</a>
                            <a href="pdoctorView.jsp"
                                class="nav-link ${param.activePage == 'doctors' ? 'active' : ''}">Doctors</a>
                            <a href="manageappointment"
                                class="nav-link ${param.activePage == 'appointments' ? 'active' : ''}">Appointments</a>
                             <a href="refundform.jsp"
                                class="nav-link ${param.activePage == 'request refund' ? 'active' : ''}">Request Refund</a>    
                            
                            <a href="about.jsp" class="nav-link ${param.activePage == 'about' ? 'active' : ''}">About</a>
                        </nav>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown d-none d-md-block">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                    <li><a class="dropdown-item" href="PatientProfile.jsp"><i class="fas fa-user me-2"></i>Update Profile</a>
                                    </li>
